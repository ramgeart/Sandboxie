...
// Certificate verification system disabled - all features are free
// static UCHAR KphpTrustedPublicKey[] = { ... completely removed ... };
    ...
    )
{
    ...
    status = STATUS_SUCCESS; // Skip verification
    goto CleanupExit;
